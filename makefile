...
TARGET = macho.so
SOURCES = $(shell echo src/*.cpp) $(shell echo src/requests/*.cpp) $(shell echo src/transport/*.cpp) $(shell echo src/rtp/*.cpp) $(shell echo src/utils/*.cpp) $(shell echo src/filters/*.cpp)
...
%.o : %.cpp
	g++ $(FLAGS) $(CFLAGS) -I$(HEADERS) -I$(REQUESTS_HEADERS) -I$(TRANSPORT_HEADERS) -I$(RTP_HEADERS) -I$(UTILS_HEADERS) -I$(FILTERS_HEADERS) -I$(CIRCINUS_PUB_HEADERS) -c $< -o $@
